...
class LumbarSpondylosisTests extends FunSuite{
  ...
  test("Parse entire RH LS SoP") {
    val result = ParserTestUtils.executeWholeParsingPipeline("F2014L00933","F2014L00933.pdf")
  ...
  {
    val result = ParserTestUtils.executeWholeParsingPipeline("F2014L00930","F2014L00930.pdf")
